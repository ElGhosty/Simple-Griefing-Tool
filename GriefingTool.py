...
|  __ \    (_)     / _(_)             |_   _|         | |
| |  \/_ __ _  ___| |_ _ _ __   __ _    | | ___   ___ | |
| | __| '__| |/ _ \  _| | '_ \ / _` |   | |/ _ \ / _ \| |
| |_\ \ |  | |  __/ | | | | | | (_| |   | | (_) | (_) | |
 \____/_|  |_|\___|_| |_|_| |_|\__, |   \_/\___/ \___/|_|
                                __/ |
                               |___/
...
def menu():
	...
	banner()
	print(f"""
{Fore.LIGHTRED_EX}1 - {Fore.LIGHTCYAN_EX}Port Scan
{Fore.LIGHTRED_EX}2 - {Fore.LIGHTCYAN_EX}Subdomains Finder
{Fore.LIGHTRED_EX}3 - {Fore.LIGHTCYAN_EX}Dedicados Finder
	\n
	""")
...
while True:
	...
	if menu_opciones == "1":
		...
		target = input(f"{Fore.LIGHTRED_EX}IP > {Fore.WHITE}")
		port1 = input(f"{Fore.LIGHTRED_EX}Start Port > {Fore.WHITE}")
		port2 = input(f"{Fore.LIGHTRED_EX}End Port > {Fore.WHITE}")
		startport = int(port1)
		endport= int(port2)
		print("\n")
		clear()
		...
		def portscan(port):
			...
			try:
				...
				with print_lock:
					print(f"{Fore.LIGHTRED_EX}Find > {Fore.WHITE}{target}:{port}")
				con.close()
			except:
				pass
		...
		for ejecutar0 in subdomains0:
			try:
				...
				if iphost0.startswith("104."):
					print(f"{Fore.LIGHTRED_EX}Find > {Fore.LIGHTGREEN_EX}{str(ejecutar0)}.{str(xyy)} {Fore.LIGHTCYAN_EX}({str(iphost0)}) {Fore.LIGHTRED_EX}(CloudFlare)")
				else:
					print(f"{Fore.LIGHTRED_EX}Find > {Fore.LIGHTGREEN_EX}{str(ejecutar0)}.{str(xyy)} {Fore.LIGHTCYAN_EX}{str(iphost0)}")
			except:
				pass
    ...
    ##DEDICADOS
		...
		for execute in subdomains:
			try:
				...
				print(f"{Fore.LIGHTRED_EX}Find > {Fore.LIGHTGREEN_EX}"+ipvic+":25565")
			except:
				pass
		print("\n")
		input(f'{Fore.LIGHTRED_EX}> Presiona Enter Para Volver!')
